...
r = 0.63e-3;      % Radius of one circular fiber

k    = ((1-Vf_target)^3) / (4.2*(6/(2*r))^2 *Vf_target^2);    % permeability [m^2]
...
% specify grid dimensions: 4 rows × 5 cols = 20 circles
nRows = 4;
nCols = 5;
...
max_iterations = 6000; % Safety break to prevent infinite loops
iteration = 0;
